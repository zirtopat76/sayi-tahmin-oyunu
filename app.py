...
def handle_guess():
    ...
    # Giriş yapıldıktan sonra input kutusunu temizleyerek placeholder'a dömesini sağla
    st.session_state.user_guess = ""
...
with col_input:
    # Enter'a basıldığında on_change üzerinden handle_guess çalışır ve kutu sıfırlanır
    st.text_input("Tahmin", placeholder="Guess", key="user_guess", on_change=handle_guess)

with col_btn:
    # Gülümseyen butona tıklandığında da aynı işlem gerçekleşir
